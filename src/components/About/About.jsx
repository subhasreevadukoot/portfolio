    ...
    <div className='about'>
            ...
            <Card border='light'>
              <Card.Body>
                ...
                <Card.Text className='job'>
                  Software Engineer II at Toast, Inc
                </Card.Text>
      ...
      <p align='justify'>P.S : This porfolio is a work in progress, and it will always be.</p>
                ...
                <Card.Text className='icons'>
                  ...
                  <a
                    style={{ textDecoration: "none", color: "black" }}
                    href='https://www.linkedin.com/in/subhasree-vadukoot/'
                    target='_blank'
                    rel='noreferrer'
                  >
                    {" "}
      ...
      <CardColumns
        id='details'
        className='d-flex justify-content-center about-section'
      >
                  ...
                  <Card.Body>
                    ...
                    <Card.Text className='about-text'>
                      ...
                      <p>
                        <ul>
                          <li>
                            Building innovative pricing solutions for restaurants as part of the R&D Fintech Org.
                          </li>

                          <li>
                            Developed critical payments pricing features such as order processing fees.
                          </li>
                          <li>
                            Technologies: Kotlin, Java, AWS, Dropwizard, Guice, Apache Camel, Apache Pulsar
                          </li>
                        </ul>
                      </p>
                    </Card.Text>
                ...
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text className='about-text'>
                      <p>
                        <strong>
                          Software Engineer II at Dell Technolgies{" "}
                        </strong>
                      </p>
                      <p>
                        <ul>
                          <li>
                            Building applications that help Dell Support Agents
                            resolve issues with various Dell Assets like
                            Powerstores and Poweredges real time.
                          </li>

                          <li>
                            Involved in the complete lifecycle of software
                            development in a team that follows TDD and DevOps
                            Culture
                          </li>
                          <li>
                            Technologies: Kotlin, Angular, SpringBoot,
                            Microservices, Docker, JUnit, Jasmine, Jest
                          </li>
                        </ul>
                      </p>
                    </Card.Text>
            ...
            <Col>
              <div className='about-section-subject'>
                <Card>
                  ...
                  <Card.Body>
                    <Card.Title className='about-head'>
                      Subject Areas
                    </Card.Title>
                    <Card.Text className='about-text'>
                      <ListGroup variant='flush'>
                        <ListGroup.Item>
                          Web Development, Object Oriented Programming, Computer
                          networks
                        </ListGroup.Item>
                        <ListGroup.Item>
                        ...
                        <ListGroup.Item>
                          Big Data Analytics, Big Data Management, Applied Data
                          Analytics
                        </ListGroup.Item>
                        <ListGroup.Item>
                        ...
                        <ListGroup.Item>
                          Cloud Computing, Concurrent and Parallel Programming
                        </ListGroup.Item>
                        <ListGroup.Item>
                          Linear Algebra, Complex Analysis, Differential
                          Calculus, Embedded Systems
                        </ListGroup.Item>
                      </ListGroup>
                    </Card.Text>
                  </Card.Body>
                ...
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text className='about-text'>
                      <ListGroup variant='flush'>
                        <ListGroup.Item>
                          Java, SpringBoot, R, HTML{" "}
                        </ListGroup.Item>
                        <ListGroup.Item>MySQL, Oracle</ListGroup.Item>
                        <ListGroup.Item>BootStrap, CSS, SASS </ListGroup.Item>
                        <ListGroup.Item>
                          <strong>Tools:</strong> Visual Studio Code, Toad,
                          Weka, RStudio, Jupyter Notebook, Tableau, IntelliJ,
                          Chrome Dev Tools
                        </ListGroup.Item>
                        <ListGroup.Item>
                          Agile, Scrum, Git, BitBucket
                        </ListGroup.Item>
                      </ListGroup>
                    </Card.Text>
                  </Card.Body>
